  ...
  admin?: {
    ...
    auth?: {
      ...
      events?: {
         ...
         * @default undefined
         */
        onConnectionSuccess?: (event: { user: any; provider: any }) => void;
         ...
         * @default undefined
         */
        onConnectionError?: (event: { error: any; provider: any }) => void;
      };
      /**
...
export type StrapiConfigPlugins = StrapiConfigPluginSettings;

export type StrapiConfigBaseHookSettings = Record<string, any>;

export interface StrapiConfigBasePluginSettings extends Record<string, any> {
  /**
...
export interface StrapiConfigBaseMiddlewareSetting extends Record<string, any> {
  /**
...
export interface StrapiConfigBaseMiddlewareSettings
  extends Record<string, StrapiConfigBaseMiddlewareSetting | undefined> {
  favicon?: {
    /**
